...
public class album_opened extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_album_opened);
    ...
    private void openMusicPlayingActivity() {
        Intent intent = new Intent(album_opened.this, music_playing.class);
