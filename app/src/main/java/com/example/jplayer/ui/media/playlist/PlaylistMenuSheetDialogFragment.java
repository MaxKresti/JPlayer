...
public class PlaylistMenuSheetDialogFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // Надуваем макет для контекстного меню плейлиста
        View view = inflater.inflate(R.layout.context_menu_playlist, container, false);
