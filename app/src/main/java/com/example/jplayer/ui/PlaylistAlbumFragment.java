...
public class PlaylistAlbumFragment extends Fragment {
    ...
    private void playTrack() {
        ...
        animateButton(binding.play, R.drawable.play); // Здесь замените на нужную иконку паузы
    ...
    private void pauseTrack() {
        ...
        animateButton(binding.play, R.drawable.pause); // Здесь замените на нужную иконку воспроизведения
